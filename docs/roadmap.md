...
- **Licensing & branding**: finalize the project license (likely
  Apache-2.0 + NOTICE with third-party attribution, preserving
  `inspiration/` licensing), provenance note, and the non-affiliation
  disclaimer everywhere user-facing. Required before distributing
  binaries.
